...
'''Defines the logic behind the display of message and color on the board'''
...
def display_update(self, msg, color="blue"):
    '''Displays message and color update on the board'''
